...
const (
	...
	KEY_RECORDSVC_POSTGRES_URI     = "recordsvc.postgresURI"
	...
	KEY_HOOKSVC_POSTGRES_URI     = "hooksvc.postgresURI"
...
func (config FileEnvironmentConfiguration) GetRecordServicePostgresURI() string {
	return viper.GetString(KEY_RECORDSVC_POSTGRES_URI)
}
...
func (config FileEnvironmentConfiguration) GetHookServicePostgresURI() string {
	return viper.GetString(KEY_HOOKSVC_POSTGRES_URI)
}
